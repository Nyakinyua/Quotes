...
export class QuoteComponent implements OnInit {
  quote:Quote[] = [
    new Quote(1, 'All you need is love. But a little chocolate now and then does not hurt', 'Charles M. Schulz','new','one',10,5 ,new Date(2019,10,12)),
    new Quote(2,'Lord, grant that I might not so much seek to be loved as to love','Francis of Assisi','me', 'you',2,5,new Date (2017,3,14)),
    new Quote(3,"I like the night Without the dark, we'd never see the stars" ,'Ritu Ghatourey','Rose','stomp',3,1, new Date(2019,10,25)),
